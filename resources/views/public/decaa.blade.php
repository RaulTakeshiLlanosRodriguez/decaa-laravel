        ...
        <article class="contenido">
            ...
            <div id="talento" class="contenido-item">
                ...
                <ul class="lista-oficinas">
                    <li><a href="{{ url('/oseil') }}"><i class="fas fa-user-graduate"></i>Oficina de Seguimiento al Egresado
                            y de Inserción Laboral</a></li>
                    <li><a href="{{ url('/ogc') }}"><i class="fas fa-tasks"></i>Oficina de Gestión de Calidad</a></li>
                    <li><a href="{{ url('/oaac') }}"><i class="fas fa-search"></i>Oficina de Autoevaluación y Acreditación
                            de la Calidad</a></li>
